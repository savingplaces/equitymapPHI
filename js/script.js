...
/////////////////Add Population Census Tract Data//////////////////////////
        ...
        var popTracts = new FeatureLayer({
          url:"https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Philly_Equity_Lots_20190926/FeatureServer",
          maxScale: 0,
          minScale: 0,   
...
/**************************Add Non-Study Census Tracts******************************/
        ...
        var nonStudyTracts = new FeatureLayer({
          url:"https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/PHL_NonStudy_Tracts/FeatureServer",
          maxScale: 0,
          minScale: 0,
          opacity: 1,
          renderer: {  
...
/**************************Add HAAN Tracts******************************/
        ...
        var Haan = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Philadelphia_Historically_African_American_Neighborhoods/FeatureServer",
          maxScale: 0,
          minScale: 0,
          visible: true,     
          legendEnabled: true,    
...
/**************************Add HTC Project Points******************************/
        ...
        var htcProj = new FeatureLayer ({
            ...
            definitionExpression: "city = 'Philadelphia' AND state = 'PA' AND part3 >= '2009-01-01 00:00:00' AND part3 <= '2016-12-31 00:00:00'",
            maxScale: 0,
            minScale: 500000,
            visible: false,
            popupEnabled: true, 
...
/**************************Add Local HDs******************************/
        ...
        var localHd = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Philadelphia_Local_Historic_Districts/FeatureServer",
          definitionExpression: "designated < '1/01/2017'",   
          maxScale: 0,
          minScale: 500000,
          opacity: 0.9,    
          legendEnabled: true,
...
/**************************Add NRHP Sites******************************/
        ...
        var nrhpSites = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/PHL_NRHP_Sites/FeatureServer",
...
/**************************Add NRHP HDs******************************/
        ...
        var nrhpHd = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Philadelphia_National_Register_Historic_Districts/FeatureServer",    
          definitionExpression: "NAME LIKE '%Historic District'",
          maxScale: 0,
          minScale: 500000,
          opacity: 0.9,    
          legendEnabled: true,
...
/**************************Add Public Transportation Stations Layer******************************/
       ...
       const ctaLabel = {    
        ...
        var ctaStations = new FeatureLayer ({
            url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/SEPTA_Stations/FeatureServer",
            maxScale: 0,
            minScale: 50000,
            legendEnabled: true,
            visible: false,
        ...
        const ctaRenderer = {
          ...
          uniqueValueInfos: [{
            ...
            value: "Norristown Highspeed Line",
            symbol: groupNorris,
            label: "Norristown Highspeed Line"
          }, {
            value: "Market-Frankford Line",
            symbol: groupMarket,
            label: "Market-Frankford Line"
          }, {
            value: "Trolley Line",
            symbol: groupTrolley,
            label: "Trolley Line"
        ...
        var ctaLines = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/SEPTA_Lines/FeatureServer",
          maxScale: 0,
          minScale: 500000,
          opacity: 0.8,    
          legendEnabled: true,
        ...
        var ctaLinesBack = new FeatureLayer({
          ...
          popupTemplate: {
                content: 
                "<table style='width:100%'><tbody><tr style='border:0px solid'><td align='center' style='padding:2px'><h3>SEPTA Transit Line</h3></td></tr></tbody></table>"+"<table style='border:2px solid #b8b8b8; border-collapse:collapse; width:100%'><tbody><tr style='border:2px solid #d1d1d1'><td align='left' colspan='2' style='background-color: #d8cebc ;padding:5px'><h4>{Route}</h4></td></tbody></table><br>"
            },    
          popupEnabled: true,   
          renderer: {
                type: "simple",
        ...
        var collUniv = new FeatureLayer ({
            url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Philadelphia_Universities_and_Colleges/FeatureServer",
            maxScale: 0,
            minScale: 500000,
            visible: false,
            legendEnabled: true,
       ...
       const demoRenderThree = {
        ...
        var demoPermits = new FeatureLayer ({
           url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/PHL_Demo_Permits/FeatureServer",
           ...
           popupTemplate: {
                content: 
                "<table style='width:100%'><tbody><tr style='border:0px solid;'><td align='center' style='padding:2px'><h3>Demolition Permit</h3></td></tr></tbody></table>"+"<table style='border:2px solid #d1d1d1; border-collapse:collapse; width:100%'><tbody><tr style='border:2px solid #d1d1d1'><td align='center' colspan='2' style='background-color: #d8cebc ;padding:5px'><b><h4>Permit Information</h4></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>Type</h5></td><td align='center' style='padding:5px; border: 1px solid #d1d1d1;' width='70%'><h6>Demolition</h6></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>Issue Date</h5></td><td align='center' style='padding:5px; border: 1px solid #d1d1d1;' width='70%'><h6>{permitissu}</h6></td></tr></tbody></table><br>"
                }
        });
...
/****************************Red Line Data*************************/
        ...
        var redLine = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Philly_Redline/FeatureServer",
          maxScale: 0,
          minScale: 500000,
          opacity: 0.8,    
          legendEnabled: true,
...
/**************************Add Neighborhood Boundaries******************************/
        ...
        var allNeighbor = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Philadelphia_Neighborhoods/FeatureServer", 
          maxScale: 0,
          minScale: 0,
          opacity: 1,    
          legendEnabled: true,
        ...
        const farRenderer = {
          ...
          field: "ZoningGroup",
          legendOptions: {
            title: "Philadelphia Zoning Districts"
          },
          //defaultSymbol: { type: "simple-fill" },  
          uniqueValueInfos: [{
            value: "Commercial/Commercial Mixed-Use",
            symbol: group_1,
            label: "Commercial"
          }, {
            value: "Industrial/Industrial Mixed-Use",
            symbol: group_2,
            label: "Industrial"
          }, {
            value: "Residential/Residential Mixed-Use",
            symbol: group_3,
            label: "Residential"
          }, {
        ...
        var zoningBounds = new FeatureLayer({
          url: "https://services.arcgis.com/fLeGjb7u4uXqeF9q/arcgis/rest/services/Zoning_BaseDistricts/FeatureServer",
          maxScale: 0,
          minScale: 500000,
          opacity: 0.5,    
          legendEnabled: true,
          ...
          popupTemplate: ({
                content: [
                    {
                        type: "text",
                        text: "<table style='width:100%'><tbody><tr style='border:0px solid'><td align='center' style='padding:2px'><h3>Zoning Districts</h3></td></tr></tbody></table>"+"<table style='border:2px solid #b8b8b8; border-collapse:collapse; width:100%'><tbody><tr style='border:2px solid #d1d1d1'><td align='left' colspan='2' style='background-color: #d8cebc ;padding:5px'><h4>{ZONINGGROUP} Zone ({Long_Code})</h4></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>More Information</h5></td><td align='center' style='padding:5px; border: 1px solid #b8b8b8;' width='70%'><h6><a href='https://www.phila.gov/media/20200213115058/NEW-ZONING-GUIDE_2020.pdf' target='_blank'>Learn more about {Long_Code} Zoning Districts</a></h6></td></tr></tbody></table><br>"
                    }
                ],
              expressionInfos: arcadeExpressionInfos
            }),    
        ...
        var cityLimits = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Philadelphia_City_Limits/FeatureServer",
          legendEnabled: false,
          visible: true,
          maxScale: 0,
          minScale: 0,
